...
Hy1= ((unitx*unity*(1-cos(2.186)) + unitz*sin(2.186))*midx) +((cos(2.186) + unity*unity*(1-cos(2.186)))*midy) + ((unity*unitz*(1-cos(2.186)) - unitx*sin(2.186))*midz);

Hz1= ((unitz*unitx*(1-cos(2.186)) - unity*sin(2.186))*midx) + ((unitz*unity*(1-cos(2.186)) + unitx*sin(2.186))*midy) + ((cos(2.186) + unitz*unitz*(1-cos(2.186)))*midz);
